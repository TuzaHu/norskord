...
class PREPPLingoGame:
    def __init__(self):
        ...
        # GUI setup
        self.root = tk.Tk()
        self.root.title("PREPP-Lingo - Advanced Norwegian Language Learning")
    ...
    def setup_gui(self):
        ...
        # Professional PREPP-Lingo color scheme
        self.colors = {
        ...
        style.map('Secondary.TButton', 
                 background=[('active', self.colors['dark_gray']),
        ...
        # App title - Professional styling
        title_label = tk.Label(header_frame, text="PREPP-Lingo", 
                              font=('Segoe UI', 28, 'bold'), 
                              fg=self.colors['primary'], bg='white')
        title_label.pack(pady=(10, 5))
        
        subtitle_label = tk.Label(header_frame, text="Norsk Diktat Øvelse", 
                                 font=('Segoe UI', 13), 
        ...
        # Input field - LARGER AND MORE PROMINENT with text wrapping
        input_frame = tk.Frame(self.content_frame, bg='white')
        input_frame.pack(fill=tk.X, pady=(10, 30))
        
        # Use Text widget instead of Entry for wrapping support
        self.input_entry = tk.Text(input_frame, 
                                   font=('Segoe UI', 24, 'bold'),  # Larger font
                                   height=3,  # Allow 3 lines for wrapping
                                   ...
                                   padx=10,
                                   pady=10)
        self.input_entry.pack(fill=tk.X, pady=10)
        self.input_entry.config(state='disabled')
        
        # Center align text in Text widget
        self.input_entry.tag_configure("center", justify='center')
        self.input_entry.tag_add("center", "1.0", "end")
        
        # Keep input_var for compatibility
    ...
    def use_hint(self):
        ...
        if hasattr(self, 'input_entry'):
            ...
            self.input_entry.insert("1.0", self.current_word)
            self.input_entry.tag_add("center", "1.0", "end")
    ...
    def submit_answer(self, event=None):
        ...
        # Get text from Text widget instead of Entry
        player_answer = self.input_entry.get("1.0", "end-1c").strip()
